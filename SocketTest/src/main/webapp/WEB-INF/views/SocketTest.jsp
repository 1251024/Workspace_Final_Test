...
<body>
	<h1 style="text-align: center;">WebSocket Client Test</h1>
	<br>
	<div style="text-align: center;">
		<form action="">
			<input id="sendBtn" value="Send" type="button">&nbsp; <input
				id="message" name="message" value="Have a good day" type="text"><br>
			Server Message : <input id="serverMessage" name="serverMessage"
				type="text"><br>
		</form>
	</div>
	<div id="output"></div>
