...
public class ChatMessageDto {
	...
	public ChatMessageDto(String message_id, String message_sender, String message_receiver, String message_content,
	...
	public static ChatMessageDto convertMessage(String source) {
		ChatMessageDto message = new ChatMessageDto();
		Gson gson = new Gson();
		message = gson.fromJson(source,  ChatMessageDto.class);
		return message;
	}
